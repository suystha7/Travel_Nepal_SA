...
import { useCreateBlogCategory } from '../hooks/useCreateBlogCategory';
...
const CreateBlogCategoryModal: React.FC<IProps> = ({ closeModal }) => {
  const { formik, isLoading } = useCreateBlogCategory({ closeModal });
