...
import { useUpdateBlogImage } from '../hooks/useUpdateBlogImage';
...
const UpdateBlogImageModal: React.FC<IProps> = ({ closeModal, updateId }) => {
  const { formik, isLoading, blogOptions } = useUpdateBlogImage({ closeModal, updateId });
  return (
...
export default UpdateBlogImageModal;
