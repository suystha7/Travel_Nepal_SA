...
import { useUpdatePackageVideo } from '../hooks/useUpdatePackageVideo';
...
const UpdatePackageVideoModal: React.FC<IProps> = ({ closeModal, updateId }) => {
  const { formik, isLoading, packageOptions } = useUpdatePackageVideo({ closeModal, updateId });
...
export default UpdatePackageVideoModal;
