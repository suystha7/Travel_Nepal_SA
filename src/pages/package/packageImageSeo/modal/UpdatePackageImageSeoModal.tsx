...
import BlogImageForm from '../partials/PackageImageSeoForm';
...
const UpdatePackageImageSeoModal: React.FC<IProps> = ({ closeModal, updateId }) => {
  const { formik, isLoading, packageOptions } = useUpdateBlogImageSeo({ closeModal, updateId });
  return (
    <FormikProvider value={formik}>
      <form>
        <div className="max-h-[80vh] overflow-y-auto" style={{ scrollbarWidth: 'thin' }}>
          <BlogImageForm packageOptions={packageOptions} />
...
export default UpdatePackageImageSeoModal;
