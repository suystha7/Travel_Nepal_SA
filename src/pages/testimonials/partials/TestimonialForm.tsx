  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="grid grid-cols-2 gap-x-6 gap-y-2 bg-white container-shadow rounded-md px-2">
        <InputText required label="Name" name="name" placeholder="Enter name..." readOnly />

        <InputText required label="Rating" name="rating" placeholder="Enter rating..." readOnly />

        <InputFileWithPreview label="Image" name="image" required  readonly/>
      </div>

      <div className="px-2">
        <TextEditor label="Message" name="message" required readonly/>
      </div>
    </div>
  )
}
