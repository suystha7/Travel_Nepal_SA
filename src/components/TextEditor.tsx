...
const MenuBar = React.memo(function MenuBar({ editor }: { editor: Editor | null }) {
    ...
    <div className="bg-gray-50 px-4 py-2 border-b">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button
          ...
          className={`p-2 rounded ${editor.isActive('bold') ? 'bg-green-100 text-green-600' : 'hover:bg-gray-200'}`}
        >
          <Bold size={16} />
        </button>
        <button
          ...
          className={`p-2 rounded ${editor.isActive('italic') ? 'bg-green-100 text-green-600' : 'hover:bg-gray-200'}`}
        >
          <Italic size={16} />
        </button>
        <button
          ...
          className={`p-2 rounded ${editor.isActive('underline') ? 'bg-green-100 text-green-600' : 'hover:bg-gray-200'}`}
        >
        ...
        <button
          ...
          className={`p-2 rounded ${editor.isActive('strike') ? 'bg-green-100 text-green-600' : 'hover:bg-gray-200'}`}
        >
        ...
        <button
          ...
          className={`p-2 rounded ${editor.isActive('bulletList') ? 'bg-green-100 text-green-600' : 'hover:bg-gray-200'}`}
        >
          <List size={16} />
        </button>
        <button
          ...
          className={`p-2 rounded ${editor.isActive('orderedList') ? 'bg-green-100 text-green-600' : 'hover:bg-gray-200'}`}
        >
          <ListOrdered size={16} />
        </button>
        ...
        <button
          ...
          className={`p-2 rounded ${editor.isActive('blockquote') ? 'bg-green-100 text-green-600' : 'hover:bg-gray-200'}`}
        >
          <Quote size={16} />
        </button>
...
const TextEditor: React.FC<TextEditorProps> = ({
  ...
  const editor = useEditor({
    ...
    onUpdate: ({ editor }) => helpers.setValue(editor.getHTML()),
  });
